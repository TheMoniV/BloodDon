...
public class ConversationFragment extends android.app.Fragment implements InternetConnectivityListener {
    ...
    private ImageView convSearchIcon;
    private ImageView mainProfileIcon;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        convSearchIcon      = mMainView.findViewById(R.id.convSearchIcon);
        mainProfileIcon      = mMainView.findViewById(R.id.mainProfileIcon);
        ...
        ImageView mainSearchIcon = mMainView.findViewById(R.id.mainSearchIcon);
        fragmentManager = getFragmentManager();
        ft = fragmentManager.beginTransaction();
        bloodSeachAnimationFragment = new SearchFragment();
        userProfileFragment = new UserProfileFragment();

        convSearchIcon.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mainProfileIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ft.setCustomAnimations(R.animator.slide_in_left,R.animator.slide_out_right, 0, 0);
    ...
    public static class ConvViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setUserImage(String thumb_image, Context ctx) {
            ...
            final CircleImageView userImageView = (CircleImageView) mView.findViewById(R.id.usersProfilePic);
//
