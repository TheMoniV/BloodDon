        ...
        public MyViewHolder(View view) {
            ...
            ProfilePicture.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent usersProfile = new Intent(mContext, UsersProfile.class);
                    usersProfile.putExtra("otherUserId",uniqueViewHolderCurrentUser.userId);
                    mContext.startActivity(usersProfile);
